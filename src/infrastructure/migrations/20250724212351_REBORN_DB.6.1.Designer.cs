...
namespace med_consult_api.src.infrastructure.migrations
{
    ...
    [Migration("20250724212351_REBORN_DB.6.1")]
    partial class REBORN_DB61
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("med_consult_api.src.domain.AppointmentConsultDone", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("AdministrativeId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("AppointmentConsultScheduleId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AppointmentConsultScheduleId");

                    b.ToTable("AppointmentConsultDones");
                });

            modelBuilder.Entity("med_consult_api.src.domain.AppointmentConsultRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppointmentConsultRequests");
                });

            modelBuilder.Entity("med_consult_api.src.domain.AppointmentConsultSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("AppointmentConsultRequestId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AppointmentConsultRequestId");

                    b.ToTable("AppointmentConsultSchedules");
                });

            modelBuilder.Entity("med_consult_api.src.domain.AppointmentExamDone", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("AppointmentExamScheduleId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AppointmentExamScheduleId");

                    b.ToTable("AppointmentExamDones");
                });

            modelBuilder.Entity("med_consult_api.src.domain.AppointmentExamRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppointmentExamRequests");
                });

            modelBuilder.Entity("med_consult_api.src.domain.AppointmentExamSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("AppointmentExamRequestId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AppointmentExamRequestId");

                    b.ToTable("AppointmentExamSchedules");
                });
            ...
            modelBuilder.Entity("med_consult_api.src.domain.AppointmentConsultDone", b =>
                {
                    b.HasOne("med_consult_api.src.domain.UserProfile", "Administrative")
                        .WithMany()
                        .HasForeignKey("AdministrativeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("med_consult_api.src.domain.AppointmentConsultSchedule", "AppointmentConsultSchedule")
                        .WithMany()
                        .HasForeignKey("AppointmentConsultScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Administrative");

                    b.Navigation("AppointmentConsultSchedule");
                });
            ...
            modelBuilder.Entity("med_consult_api.src.domain.AppointmentConsultSchedule", b =>
                {
                    ...
                    b.HasOne("med_consult_api.src.domain.AppointmentConsultRequest", "AppointmentConsultRequest")
                        .WithMany()
                        .HasForeignKey("AppointmentConsultRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Administrative");

                    b.Navigation("AppointmentConsultRequest");
                });
            ...
            modelBuilder.Entity("med_consult_api.src.domain.AppointmentExamDone", b =>
                {
                    ...
                    b.HasOne("med_consult_api.src.domain.AppointmentExamSchedule", "AppointmentExamSchedule")
                        .WithMany()
                        .HasForeignKey("AppointmentExamScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Administrative");

                    b.Navigation("AppointmentExamSchedule");
                });
            ...
            modelBuilder.Entity("med_consult_api.src.domain.AppointmentExamSchedule", b =>
                {
                    ...
                    b.HasOne("med_consult_api.src.domain.AppointmentExamRequest", "AppointmentExamRequest")
                        .WithMany()
                        .HasForeignKey("AppointmentExamRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Administrative");

                    b.Navigation("AppointmentExamRequest");
                });
            ...
            modelBuilder.Entity("med_consult_api.src.domain.ClinicalConsultAct", b =>
                {
                    b.HasOne("med_consult_api.src.domain.AppointmentConsultRequest", null)
                        .WithMany("ClinicalConsultActs")
                        .HasForeignKey("AppointmentConsultRequestId");
            ...
            modelBuilder.Entity("med_consult_api.src.domain.ClinicalExamAct", b =>
                {
                    b.HasOne("med_consult_api.src.domain.AppointmentExamRequest", null)
                        .WithMany("ClinicalExamActActs")
                        .HasForeignKey("AppointmentExamRequestId");
            ...
            modelBuilder.Entity("med_consult_api.src.domain.AppointmentConsultRequest", b =>
                {
                    b.Navigation("ClinicalConsultActs");
                });

            modelBuilder.Entity("med_consult_api.src.domain.AppointmentExamRequest", b =>
                {
                    b.Navigation("ClinicalExamActActs");
                });
