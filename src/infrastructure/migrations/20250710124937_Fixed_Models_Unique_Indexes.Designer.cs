...
namespace med_consult_api.src.infrastructure.migrations
{
    ...
    [Migration("20250710124937_Fixed_Models_Unique_Indexes")]
    partial class Fixed_Models_Unique_Indexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("med_consult_api.src.domain.AuthUser", b =>
                {
                    ...
                    b.HasOne("med_consult_api.src.domain.UserProfile", "UserProfile")
                        .WithOne("AuthUser")
                        .HasForeignKey("med_consult_api.src.domain.AuthUser", "UserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
