...
namespace med_consult_api.src.infrastructure.migrations
{
    ...
    [Migration("20250711175214_REBORN_DB.5")]
    partial class REBORN_DB5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("med_consult_api.src.domain.AppointmentRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("med_consult_api.src.domain.AppointmentScheduleRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppointmentScheduleRequests");
                });
            ...
            modelBuilder.Entity("med_consult_api.src.domain.RequestConsult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ClinicalConsultActId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ClinicalConsultActId");

                    b.ToTable("RequestConsults");
                });

            modelBuilder.Entity("med_consult_api.src.domain.RequestExam", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ClinicalExamActId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("med_consult_api.src.domain.AppointmentScheduleRequest", b =>
                {
                    b.HasOne("med_consult_api.src.domain.AppointmentRequest", "AppointmentRequest")
                        .WithMany()
            ...
            modelBuilder.Entity("med_consult_api.src.domain.RequestConsult", b =>
                {
                    b.HasOne("med_consult_api.src.domain.AppointmentRequest", "AppointmentRequest")
                        .WithMany("RequestConsults")
                        .HasForeignKey("AppointmentRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("med_consult_api.src.domain.ClinicalConsultAct", "ClinicalConsultAct")
                        .WithMany()
                        .HasForeignKey("ClinicalConsultActId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppointmentRequest");

                    b.Navigation("ClinicalConsultAct");
                });
            ...
            modelBuilder.Entity("med_consult_api.src.domain.RequestExam", b =>
                {
                    ...
                    b.HasOne("med_consult_api.src.domain.ClinicalExamAct", "ClinicalExamAct")
                        .WithMany()
                        .HasForeignKey("ClinicalExamActId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppointmentRequest");

                    b.Navigation("ClinicalExamAct");
                });
