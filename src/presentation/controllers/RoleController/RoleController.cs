...
public class RoleController : DefaultController<Role, CreateRoleDTO, RoleDTO, UpdateRoleDTO, RoleFactory>
{
    ...
    public override async Task<ActionResult<RoleDTO>> Create([FromBody] CreateRoleDTO dto)
    {
    ...
    /*     [Authorize]
        [Authorize(Roles = "ADMIN")] */
    public override async Task<ActionResult<Response>> Update(Guid id, [FromBody] UpdateRoleDTO dto)
    {
