...
public class SpecialityController : DefaultController<SubsystemHealth, CreateSubsystemHealthDTO, SubsystemHealthDTO, UpdateSubsystemHealthDTO, SubsystemHealthFactory>
{
    public SpecialityController(IService<SubsystemHealth, CreateSubsystemHealthDTO, SubsystemHealthDTO, UpdateSubsystemHealthDTO> service)
        : base(service) { }
