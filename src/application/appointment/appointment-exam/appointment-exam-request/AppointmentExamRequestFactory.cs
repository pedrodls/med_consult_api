...
public class AppointmentExamRequestFactory : IFactory<AppointmentExamRequest, CreateAppointmentExamRequestDTO, UpdateAppointmentExamRequestDTO>
{
    public AppointmentExamRequest Create(CreateAppointmentExamRequestDTO dto)
    {
        ...
        return new AppointmentExamRequest(dto.UserProfileId, dto.StartDate, dto.EndDate, dto.Observations);
    }

    public AppointmentExamRequest Update(AppointmentExamRequest entity, UpdateAppointmentExamRequestDTO updateDTO)
    {
